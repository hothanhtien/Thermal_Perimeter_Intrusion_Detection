...
![Confusion matrix (tập test)](figures/06_confusion_matrix_test.png)

![PR curve (tập test)](figures/06_pr_curve_test.png)
...
![Recall theo kích thước bbox](figures/06_recall_by_bbox_size.png)
...
![Ảnh mẫu: ground truth vs prediction](figures/06_sample_predictions.png)
